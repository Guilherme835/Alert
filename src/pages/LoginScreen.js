    ...
    */
                                                            ...
                                                            .then( user => {
                                                                ...
                                                                Alert.alert(
                                                                    ...
                                                                    [
                                                                        {
                                                                            text:'OK',
                                                                            onPress:()=> {console.log('Erro ao tentar criar usuario' ,error)}
                                                                        }
                                                                    ]
                                                                )
        ...
        //TRATA UM ERRO DE TENTATIVA DE LOGIN
            ...
            Alert.alert(
                ...
                [
                    {
                        text:'OK',
                        onPress:()=> {console.log('Erroo ao tentar logar', error)}
                    }
                ]
            )
    ...
    componentDidMount(){
        ...
        const firebaseConfig = {
            apiKey: "AIzaSyDKkGHVIzongoipa5CKUcwzdXKR5UnhN5U",
            authDomain: "ds-pam1guilherme.firebaseapp.com",
            projectId: "ds-pam1guilherme",
            storageBucket: "ds-pam1guilherme.appspot.com",
            messagingSenderId: "568671152582",
            appId: "1:568671152582:web:0ad487ecc930cf90faeac7",
            measurementId: "G-ET55SPC57R"
          };
